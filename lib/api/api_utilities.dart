...
class ApiUtilities{
  ...
  static String CATEGORY_PRODUCT(int id){
    return MAIN_URL+'category/'+id.toString()+'/products';
  }
  static String PRODUCT_DETAILS(int id){
    return MAIN_URL+'product/'+id.toString();
  }
}